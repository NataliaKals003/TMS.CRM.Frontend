            ...
            <Grid className="customer-details-deal-page" size={{ xs: 12, md: 12 }} paddingBottom={'24px'} gap={2} alignItems={'center'}>
              <Grid container spacing={3}>
                ...
                <Grid size={{ xs: 12, sm: 12, md: 3, lg: 3 }}>
                  ...
                  <Typography className="typography-deal-page">{customer.name}</Typography>
                </Grid>
            ...
            <Grid size={{ xs: 12, md: 12 }}>
              <Grid container width={'100%'}>
                <Grid size={{ xs: 12, md: 7 }}>
                  <Box display={'flex'} marginBottom={'40px'}>
                    ...
                    <Box display={'flex'} flexDirection={'column'} flex={1}>
                      ...
                      <Typography className="typography-deal-page">{deal.appointmentDate}</Typography>
                    </Box>
                  </Box>
                  <Box display={'flex'} marginBottom={'40px'}>
                    <Box display={'flex'} flexDirection={'column'} flex={1}>
                      <Typography className="title-typography-deal-page">Room Area</Typography>
                      <Typography className="typography-deal-page">{deal.area} M&sup2;</Typography>
                    </Box>
                    <Box display={'flex'} flexDirection={'column'} flex={1}>
                      <Typography className="title-typography-deal-page">Number of people</Typography>
                      <Typography className="typography-deal-page">{deal.people}</Typography>
                    </Box>
                  </Box>
                  <Box display={'flex'} marginBottom={'40px'}>
                    <Box display={'flex'} flexDirection={'column'} flex={1}>
                ...
                <Grid size={{ xs: 12, md: 5 }} padding={'25px 24px 24px 0'}>
                  <Image
                    className="deal-image-deal-page"
